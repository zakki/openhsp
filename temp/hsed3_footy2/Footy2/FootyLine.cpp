...
/*-------------------------------------------------------------------
CFootyLine::CalcEthicLine
nPosの位置がどこら辺にくるか計算するルーチンです。
-------------------------------------------------------------------*/
CFootyLine::EthicInfo CFootyLine::CalcEthicLine(size_t nPos,size_t nColumn,size_t nTab,int nMode){
	/*宣言*/
...
/*-------------------------------------------------------------------
CFootyLine::CalcRealPosition
倫理行から実際の桁数を計算するルーチンです。nEthicLineもnEthicPosも
0ベースで渡します。
-------------------------------------------------------------------*/
size_t CFootyLine::CalcRealPosition(size_t nEthicLine,size_t nEthicPos,
									size_t nColumn,size_t nTab,int nMode){
	/*宣言*/
	const wchar_t *pWork = GetLineData();
