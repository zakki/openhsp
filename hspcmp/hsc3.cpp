...
int CHsc3::PreProcessAht( char *fname, void *ahtoption, int mode )
{
	...
	sprintf( mm,"#AHT processor ver%s / onion software 1997-2014(c)", hspver );
	tk.Mes( mm );
...
int CHsc3::PreProcess( char *fname, char *outname, int option, char *rname, void *ahtoption )
{
	...
	sprintf( mm,"#%s ver%s / onion software 1997-2014(c)", HSC3TITLE, hspver );
	tk.Mes( mm );
...
int CHsc3::Compile( char *fname, char *outname, int mode )
{
	...
	sprintf( mm,"#%s ver%s / onion software 1997-2014(c)", HSC3TITLE2, hspver );
	tk.Mes( mm );
