...
β版は、HSP3.5リリース版と共存させることが可能です。HSP3.5リリース版がインストールされているフォルダ(通常は、「C:\hsp34」になります)に上書きしないよう注意してください。(HSP3.6β版の各種設定は、既存のHSP3.5とも共有されます。)
...
LinuxのGUI環境(X Window System)及びRaspberry Pi(Raspbian Jessie)で動作するバージョンが提供されています。
...
更新履歴については、docs/history.txtをご覧ください。
