...
^
p2の情報IDと、p3の情報ビットについての詳細は、HSPDXFIX.DLLリファレンスマニュアルのDDCAPS一覧を参照してください。
...
type値についての詳細は、 HSPDXFIX.DLL リファレンスマニュアルの「type値の設定について」を参照してください。
...
ウィンドウモードで動かす際の注意点などは、HSPDXFIX.TXTの「ウィンドウモードについて」の項を参照してください。
^
