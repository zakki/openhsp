...
27     ESI_STICKSP     吸着スプライトNo.
28     ESI_STICKX      吸着スプライトとの差分座標X
29     ESI_STICKY      吸着スプライトとの差分座標Y
</pre>
^p
...
--------------------------------------------------
      ...
      6  ESSPSET_CENTER  スプライトの中心X,Y座標
      7  ESSPSET_PUTPOS  画面上の表示X,Y座標
