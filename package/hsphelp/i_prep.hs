...
"filename" : パックされるファイル
%inst
実行ファイル自動作成(ctrl+F9)で、 パックされるファイルを指定します。指定されたファイルは、実行ファイル作成時にリソースとして埋め込まれます。#packは、通常の形式でパックします。 暗号化してパックしたい場合は#epackをお使い下さい。
...
"filename" : パックされるファイル
%inst
実行ファイル自動作成(ctrl+F9)で、 パックされるファイルを指定します。指定されたファイルは、実行ファイル作成時にリソースとして埋め込まれます。#epackは、指定ファイルを暗号化してパックします。
