...
^
モジュール変数についての詳細は、プログラミングマニュアルを参照してください。
...
#deffunc命令との違いは、呼び出しの際にモジュール型の変数を指定する必要がある点です。モジュール変数の詳細については、プログラミングマニュアルのモジュール項目を参照してください。
...
モジュール変数の詳細については、プログラミングマニュアルのモジュール項目を参照してください。
^
