...
"SRC_ALPHA" write source —¯
"ONE_MINUS_SRC_ALPHA" Write source —¯ (inverted value)
"DST_ALPHA" write destination —¯
...
By specifying a negative value for the fade, the ƒ¿ value can be faded out toward 0, and by specifying a positive value, the ƒ¿ value can be faded in toward 255.
